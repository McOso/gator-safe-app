...
var getCounterfactualAccountData = async ({
  ...
  switch (implementation) {
    case "Hybrid" /* Hybrid */: {
      ...
      initcode = _chunkHBAJRXQBcjs.encode.call(void 0, { eoaOwner: owner, p256Owners });
      break;
    }
    case "MultiSig" /* MultiSig */: {
      ...
      initcode = _chunkHBAJRXQBcjs.encode2.call(void 0, { owners, threshold });
      break;
    }
  ...
  const proxyCreationCode = _chunkHBAJRXQBcjs.encodeProxyCreationCode.call(void 0, {
  ...
  const factoryData = _chunkHBAJRXQBcjs.encode3.call(void 0, proxyCreationCode, salt);
  return {
    factoryData,
    address
  };
...
var processDelegatedCall = (call) => {
  ...
  const callAsExecution = _chunkVLKX4BR6cjs.createExecution.call(void 0, { target, value, callData });
  ...
  const redeemCalldata = _viem.encodeFunctionData.call(void 0, {
    ...
    args: [
      ...
      _chunkVLKX4BR6cjs.encodeExecutionCalldatas.call(void 0, [[callAsExecution]])
    ]
  });
  return _chunkVLKX4BR6cjs.createExecution.call(void 0, {
...
var encodeCalls = (calls) => {
  if (calls.length === 1) {
    ...
    if (call && !isDelegatedCall(call)) {
      ...
      const execution = _chunkVLKX4BR6cjs.createExecution.call(void 0, { target, value, callData });
      return _chunkHBAJRXQBcjs.encode4.call(void 0, { execution });
    }
  }
  const executions = calls.map((call) => {
    ...
    const { to: target, value, data: callData } = call;
    return _chunkVLKX4BR6cjs.createExecution.call(void 0, { target, value, callData });
  });
  ...
  return _chunkHBAJRXQBcjs.encode5.call(void 0, { mode, executions });
};
...
//# sourceMappingURL=chunk-OPJBYTWX.cjs.map